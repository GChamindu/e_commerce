...
const HeaderOne = () => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        if (json.success && json.data) {
          const fetchedCats = json.data.map((c) => ({
            id: c.id,
            name: c.name,
            slug: c.slug,
          }));
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      const $select = query(".js-example-basic-single");
      ...
      // THIS IS THE FIX → Redirect when user selects anything
            ...
            <div className="flex-align menu-category-wrapper">
              ...
              <div className="category on-hover-item">
                ...
                >
                  ...
                  <span className="d-sm-flex d-none">All</span> Products
                ...
                <div
                  className={`responsive-dropdown cat on-hover-dropdown common-dropdown nav-submenu p-0 submenus-submenu-wrapper transition-all ${
                    activeCategory
                      ? "active visible opacity-100 scale-100"
                      : "invisible opacity-0 scale-95 hidden"
                  }`}
